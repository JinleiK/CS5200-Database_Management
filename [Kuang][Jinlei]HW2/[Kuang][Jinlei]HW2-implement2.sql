...
DROP TABLE IF EXISTS MobileApp;
DROP TABLE IF EXISTS DesktopApp;
...
#Application
INSERT INTO Application VALUES ('1', 'Content Management System', 'Internet Explorer', '2005-06-02');
INSERT INTO Application VALUES ('2', 'Yelp', 'IOS', '2003-04-21');
INSERT INTO Application VALUES ('3', 'Eclipse', 'Windows 7', '1998-10-26');
INSERT INTO Application VALUES ('4', 'Dropbox', 'Android', '2001-11-16');
INSERT INTO Application VALUES ('5', 'Student Management System', 'FireFox', '1999-05-19');
INSERT INTO Application VALUES ('6', 'Sequel Pro', 'MacOS', '2005-07-10');
...
#WebApp
INSERT INTO WebApp VALUES ('1', 'www.CMS.com', '12');
INSERT INTO WebApp VALUES ('5', 'www.SMS.com', '8');

#MobileApp
INSERT INTO MobileApp VALUES ('2', '2003-10-23 08:23:00');
INSERT INTO MobileApp VALUES ('4', '2002-03-11 09:15:00');

#DesktopApp
INSERT INTO DesktopApp VALUES ('3', '30');
INSERT INTO DesktopApp VALUES ('6', '5');
...
# list the names and pricePerAccess of the web applications whose pricePerAccess is less than 10	
SELECT a.appName, wa.pricePerAccess FROM Application a 
	JOIN WebApp wa ON a.appID = wa.appID 
	WHERE wa.pricePerAccess < 10;
	
# list the names, create date and installed time of the Mobile applications that installed in the different year of create date
SELECT a.appName, a.createdDate, ma.installedTime 
	FROM Application a 
	JOIN MobileApp ma ON a.appID = ma.appID 
	WHERE YEAR(a.createdDate) <> YEAR(ma.installedTime);
	
# list the targets, pricePerDownload of the desktop applications whose targets are MacOS
SELECT a.target, da.pricePerDownload 
	FROM Application a, DesktopApp da 
	WHERE a.appID = da.appID AND a.target = 'MacOS';
